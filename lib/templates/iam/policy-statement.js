...
class PolicyStatement {
    ...
    /**
     * Adds a service principal to the statement. This method will override
     * previous non service principal settings.
     *
    ...
    /**
     * Adds a canonical user principal to the statement. This method will
     * override previous non canonical user principal settings.
     *
    ...
    /**
     * Adds an IAM user principal to the statement. This method will
    ...
    /**
     * Adds the AWS account principal to the statement. This method will
     * override previous non AWS principal settings.
     *
     * @return {Object} A reference to the current object. Can be used to
     *         chain multiple calls.
