...
class FunctionTemplate extends Template {
     ...
     *
     * @param {String} name of the lambda runtime. It has to be one of the following: 'nodejs', 'nodejs4.3', 'nodejs6.10', or 'nodejs4.3-edge'.
     *
    ...
    setRuntime(runtime) {
        const permittedRuntimes = ['nodejs', 'nodejs4.3', 'nodejs6.10', 'nodejs4.3-edge'];
        if (permittedRuntimes.indexOf(runtime) === -1) {
            throw new Error('Invalid runtime (arg #1). Runtime must be one of the following: nodejs, nodejs4.3, nodejs6.10, or nodejs4.3-edge');
        }
