...
var HELP_TEXT =
    ...
    '                                                                                \n' +
    ' Supported Tasks:                                                               \n' +
    '   [default]         : Performs standard pre-checkin activities. Runs a         \n' +
    '                       formatter on all source files, validates the files       \n' +
    ...
    '                         [lint]   : Executes linting with default options       \n' +
    ...
    '                       automatically.                                           \n' +
    '                                                                                \n' +
    '   lint              : Executes linting against all source files.               \n' +
    '                                                                                \n' +
...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        esformatter: {
            options: {
                plugins: ['esformatter-ignore']
            },
            src: [LIB.allFilesPattern('js'), TEST.allFilesPattern('js')]
        },
         ...
         */
        eslint: {
            dev: ['Gruntfile.js', LIB.allFilesPattern('js'), TEST.allFilesPattern('js')]
        },
     ...
     */
    grunt.registerTask('default', ['format', 'lint', 'test:unit', 'clean']);
     ...
     */
    grunt.registerTask('test', 'Executes tests against sources', function(testType, target) {
        var testAction;
    ...
    //    on changes.
    grunt.registerTask('monitor', 'Monitors source files for changes, and performs actions as necessary', function() {
        var tasks = [];
     ...
     */
    grunt.registerTask('env', 'Shows the current environment setup', function() {
